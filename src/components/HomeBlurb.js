const HomeBlurb = () => {
  ...
  <div className="flex items-center h-4/6">
    <div className="ml-3 mr-3 sm:ml-12 sm:mr-0 sm:mt-16 p-0">
      <h1 className="font-nunito text-7xl sm:text-8xl text-light mb-4">Hi, I'm Chris.</h1>
      <p className="font-nunito leading-normal xs:leading-relaxed sm:leading-relaxed text-2xl sm:text-3xl text-light ml-1.5 ">I'm a full-stack web developer in training. Until recently, I worked as a lawyer, but my passion for coding got the better of me. I'd love to help you build modern, engaging web applications. You can get in touch with me <a href="#" className="underline">here</a>.</p>
    </div>
  </div>
  )
}
